...
def addImageOverlay(background, foreground, translationForegroundW, translationForegroundH):
    ...
    if translationForegroundW + foreW > backW:
        ...
        print("Posição final da largura do objeto da frente termina:", translationForegroundW + foreW)
...
def memeGeneratorWithBlending(fala1, imagem1, fala2, imagem2, fundo):
    ...
    cv2.imwrite("meme.jpg", finalImage)

memeGeneratorWithBlending('Respeito seu argumento!', "fotos/mulher200.jpg", 'Burro pra caramba...', "fotos/mulher200.jpg", "fotos/mulher.jpg")